...
export default function BlogPage() {
  const posts: Post[] = [
    { slug: "learning-journey", title: "从零到全栈：我的编程学习之路", description: "分享我如何从编程小白成长为全栈开发者的经历", date: "2024-04-01", category: "心路历程", tags: ["学习经验", "成长", "全栈"], readingTime: 8, pinned: true },
  ];
              ...
              <div className="lg:sticky lg:top-24 space-y-6">
                ...
                <GlassCard className="p-6 text-center">
                  <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-forest-gold/30 to-forest-accent/30 flex items-center justify-center">
                    <span className="text-3xl font-bold text-forest-gold">P</span>
                  </div>
                  <h3 className="text-lg font-medium text-forest-text mb-1">PORTAL</h3>
                  <p className="text-sm text-forest-text-dim mb-4">探索代码的浪漫</p>

                  <div className="flex justify-center gap-4 mb-4">
                    <a href="#" className="text-forest-text-dim hover:text-forest-gold transition-colors" title="GitHub">
